...
$(d).ready(function(){
  ...
  let saveForm = function() {
    ...
    let m = populateMarkers('/world/get_route','GET',{route: Ar, category: $('#id_category').val()},'json', map, markerClusterer,bounds, markers,infoWindow);
    return false;
  };
